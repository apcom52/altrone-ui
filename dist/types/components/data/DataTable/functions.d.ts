...
export declare const defaultSortFunc: ({
  itemA,
  itemB,
  field,
  direction
}: DataTableSortFunc) => 1 | -1;
...
export declare const defaultCheckboxesFilter: ({
  item,
  field,
  value
}: DataTableFilterFunc) => boolean;
export declare const filterVisibleColumns: (
