...
var useThemeContext = function () { return React.useContext(ThemeContext); };
...
var DataTableContext = React.createContext(DEFAULT_DATA_TABLE_CONTEXT);
var useDataTableContext = function () { return React.useContext(DataTableContext); };
...
var Altrone = function (_a) {
    var children = _a.children, _b = _a.theme, theme = _b === void 0 ? exports.Theme.light : _b, _c = _a.locale, locale = _c === void 0 ? 'en-US' : _c, _d = _a.lang, lang = _d === void 0 ? 'en' : _d, _e = _a.style, style = _e === void 0 ? {} : _e;
    try {
        // @ts-ignore
    ...
    return isFirstWrap
        ? jsxRuntime.exports.jsx(ThemeContext.Provider, __assign({ value: {
                ...
                lang: lang
                    ...
                    'altrone--dark': theme === exports.Theme.dark
...
var useLocalization = function () {
    ...
    var dictionary = React.useMemo(function () {
        return lang === 'ru' ? ru : en;
    }, [lang]);
    return React.useCallback(function (t, config) {
...
var Modal = function (_a) {
    ...
    var onESCPress = React.useCallback(function (e) {
        if (e.key === 'Escape') {
            handleClose();
        }
    }, [onClose]);
...
exports.FormGroupVariant = void 0;
...
var FormGroup = function (_a) {
    var _b = _a.variant, variant = _b === void 0 ? exports.FormGroupVariant.default : _b, _c = _a.align, align = _c === void 0 ? exports.Align.start : _c, children = _a.children, className = _a.className, required = _a.required, _d = _a.weights, weights = _d === void 0 ? [] : _d;
...
var ContextMenu = function (_a) {
    ...
    var _b = React.useState(null), selectedParentItem = _b[0], setSelectedParentItem = _b[1];
    var t = useLocalization();
    var onParentItemClick = React.useCallback(function (action) {
...
var ContextMenu$1 = React.memo(ContextMenu);
...
var ContextMenuItem$1 = React.memo(ContextMenuItem);
...
var ContextParentMenuItem = function (_a) {
    ...
    var _b = React.useState(false), isChildrenContextMenuVisible = _b[0], setIsChildrenContextMenuVisible = _b[1];
    ...
    var altroneRef = React.useRef(document.body.querySelector('.altrone'));
    return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [jsxRuntime.exports.jsxs("button", __assign({ className: clsx('alt-context-menu-item', {
                ...
                }, type: 'button' }, { children: [jsxRuntime.exports.jsx("div", __assign({ className: 'alt-context-menu-item__icon' }, { children: action.icon })), jsxRuntime.exports.jsx("div", __assign({ className: 'alt-context-menu-item__title' }, { children: action.title })), jsxRuntime.exports.jsx("div", __assign({ className: 'alt-context-menu-item__childrenArrow' }, { children: jsxRuntime.exports.jsx(Icon$1, { i: 'keyboard_arrow_right' }) }))] })), gtPhoneL && isChildrenContextMenuVisible && ReactDOM.createPortal(jsxRuntime.exports.jsx(FloatingBox, __assign({ targetElement: itemRef.current, placement: 'right', useRootContainer: true, onClose: function () { return setIsChildrenContextMenuVisible(false); }, offset: 8 }, { children: jsxRuntime.exports.jsx(ContextMenu$1, { onClose: onClose, menu: action.children }) })), altroneRef.current)] });
};
var ContextParentMenuItem$1 = React.memo(ContextParentMenuItem);

var Chips = function (_a) {
    var _b;
    var _c = _a.options, options = _c === void 0 ? [] : _c, _d = _a.values, values = _d === void 0 ? [] : _d, onChange = _a.onChange, SelectedIcon = _a.SelectedIcon, _e = _a.direction, direction = _e === void 0 ? exports.Direction.horizontal : _e, _f = _a.size, size = _f === void 0 ? exports.Size.medium : _f;
    var onChipClick = React.useCallback(function (value) {
    ...
    return jsxRuntime.exports.jsx("div", __assign({ className: clsx('alt-chips', (_b = {
                'alt-chips--direction-vertical': direction === exports.Direction.vertical
            },
            _b["alt-chips--size-".concat(size)] = size !== exports.Size.medium,
...
var Chips$1 = React.memo(Chips);

exports.TabListVariant = void 0;
...
var TabList = function (_a) {
    ...
    var setBackgroundPosition = React.useCallback(function () {
        if (selectedTabRef.current && variant !== exports.TabListVariant.solid) {
            var offset = variant === exports.TabListVariant.border ? 20 : 0;
    ...
    var onCloseClick = function (e, value) {
        if (variant === exports.TabListVariant.solid && onCloseTab) {
            e.stopPropagation();
            onCloseTab(value);
    ...
    var Component = variant === exports.TabListVariant.solid ? 'div' : 'button';
    return jsxRuntime.exports.jsxs("div", __assign({ className: clsx('alt-tab-list', {
            ...
            'alt-tab-list--align-end': align === exports.Align.end,
                ...
                return jsxRuntime.exports.jsxs(Component, __assign({ className: clsx('alt-tab', {
                    ...
                    }), ref: isSelected ? selectedTabRef : null, onClick: function () { return onChange(tab.value); }, "data-testid": 'alt-test-tab', disabled: tab.disabled, type: 'button' }, { children: [tab.label, (variant === exports.TabListVariant.solid && showCloseButtons && onCloseTab)
            ...
            }), (variant === exports.TabListVariant.solid && showAddTabButton && onAddTab) && jsxRuntime.exports.jsx("button", __assign({ className: 'alt-tab-list__add', onClick: onAddTab, "data-testid": 'alt-test-tab-list-add', type: 'button' }, { children: jsxRuntime.exports.jsx(Icon$1, { i: 'add' }) }))] }));
};
var TabList$1 = React.memo(TabList);

var ToolbarMenu = function (_a) {
    var _b = _a.menu, menu = _b === void 0 ? [] : _b;
    var _c = React.useState(-1), currentMenuIndex = _c[0], setCurrentMenuIndex = _c[1];
    var _d = React.useState(null), currentMenuItemNode = _d[0], setCurrentMenuItemNode = _d[1];
...
var ToolbarMenu$1 = React.memo(ToolbarMenu);

var ToolbarContext = React.createContext(null);
var useToolbarContext = function () { return React.useContext(ToolbarContext); };
var defaultOffset = {
    x: 0,
    y: 0
};
var Toolbar = function (_a) {
    ...
    var _e = React.useState(null), toolbarRef = _e[0], setToolbarRef = _e[1];
...
var ToolbarAction = React.forwardRef(function (_a, ref) {
...
var ToolbarGroup = function (_a) {
    ...
    var preventRerender = React.useRef(false);
    var invisibleExpandButton = React.useRef(null);
    var expandButton = React.useRef(null);
...
var NavigationListItem$1 = React.memo(NavigationListItem);
...
var NavigationListSubItem$1 = React.memo(NavigationListSubItem);
...
var NavigationListSubSubItem$1 = React.memo(NavigationListSubSubItem);
    ...
    return jsxRuntime.exports.jsxs("div", __assign({ className: clsx('alt-navigation-list', className) }, { children: [title && jsxRuntime.exports.jsx("div", __assign({ className: 'alt-navigation-list__title' }, { children: title })), jsxRuntime.exports.jsx("nav", __assign({ className: 'alt-navigation-list__navigation' }, { children: list.map(function (item, itemIndex) {
                    ...
                    return jsxRuntime.exports.jsxs(React.Fragment, { children: [NavigationItemComponent ? jsxRuntime.exports.jsx(NavigationItemComponent, __assign({}, itemProps)) : jsxRuntime.exports.jsx(NavigationListItem$1, __assign({}, itemProps)), (selectedItem === item.value && ((_a = item.submenu) === null || _a === void 0 ? void 0 : _a.length) > 0) && jsxRuntime.exports.jsx("div", __assign({ className: 'alt-navigation-list__navigation' }, { children: (_b = item.submenu) === null || _b === void 0 ? void 0 : _b.map(function (subitem, subitemIndex) {
                                    ...
                                    return jsxRuntime.exports.jsxs(React.Fragment, { children: [NavigationSubItemComponent ? jsxRuntime.exports.jsx(NavigationSubItemComponent, __assign({}, subItemProps)) : jsxRuntime.exports.jsx(NavigationListSubItem$1, __assign({}, subItemProps)), (selectedSubItem === subitem.value && ((_a = subitem.submenu) === null || _a === void 0 ? void 0 : _a.length) > 0) && jsxRuntime.exports.jsx("div", __assign({ className: 'alt-navigation-list__navigation' }, { children: (_b = subitem.submenu) === null || _b === void 0 ? void 0 : _b.map(function (subsubitem, subsubitemIndex) {
                                                    ...
                                                    return jsxRuntime.exports.jsx(React.Fragment, { children: NavigationSubItemComponent ? jsxRuntime.exports.jsx(NavigationSubSubItemComponent, __assign({}, subsubItemProps)) : jsxRuntime.exports.jsx(NavigationListSubSubItem$1, __assign({}, subsubItemProps)) }, subsubitemIndex);
                                                }) }))] }, subitemIndex);
                                }) }))] }, itemIndex);
                }) }))] }));
};
var NavigationList$1 = React.memo(NavigationList);
...
var Button = React.forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.role, role = _c === void 0 ? exports.Role.default : _c, _d = _a.variant, variant = _d === void 0 ? exports.ButtonVariant.default : _d, href = _a.href, className = _a.className, _e = _a.fluid, fluid = _e === void 0 ? false : _e, leftIcon = _a.leftIcon, rightIcon = _a.rightIcon, _f = _a.size, size = _f === void 0 ? exports.Size.medium : _f, _g = _a.dropdown, dropdown = _g === void 0 ? [] : _g, onClick = _a.onClick, _h = _a.type, type = _h === void 0 ? 'button' : _h, _j = _a.isIcon, isIcon = _j === void 0 ? false : _j, props = __rest$1(_a, ["children", "role", "variant", "href", "className", "fluid", "leftIcon", "rightIcon", "size", "dropdown", "onClick", "type", "isIcon"]);
    var _k = React.useState(false), isDropdownVisible = _k[0], setIsDropdownVisible = _k[1];
    var isDropdownButton = !!dropdown.length;
    var buttonRef = React.useRef(null);
    var showDropdown = React.useCallback(function () {
    ...
    return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [jsxRuntime.exports.jsxs(Box$1, __assign({ tagName: ButtonComponents[href ? 1 : 0], className: clsx('alt-button', className, (_b = {},
                    _b["alt-button--role-".concat(role)] = role !== exports.Role.default,
                    _b["alt-button--variant-".concat(variant)] = variant !== exports.ButtonVariant.default,
                    _b["alt-button--size-".concat(size)] = size !== exports.Size.medium,
...
var BasicInput = function (_a) {
    var _b;
    var errorText = _a.errorText, hintText = _a.hintText, _c = _a.size, size = _c === void 0 ? exports.Size.medium : _c, className = _a.className, children = _a.children;
    return jsxRuntime.exports.jsxs("div", __assign({ className: clsx('alt-basic-input', className, (_b = {
                'alt-basic-input--invalid': errorText
            },
            _b["alt-basic-input--size-".concat(size)] = size !== exports.Size.medium,
...
function useInputIsland(island, icon, text, disabled) {
    ...
    return React.useMemo(function () {
        ...
        else if (type === exports.InputIslandType.components) {
...
exports.InputIslandType = void 0;
...
var TextInput = React.forwardRef(function (_a, ref) {
    ...
    var wrapperRef = React.useRef(null);
    var leftIslandRef = React.useRef(null);
    var rightIslandRef = React.useRef(null);
...
var TextInput$1 = React.memo(TextInput);
...
var PasswordInput = function (_a) {
    ...
    var togglePasswordVisible = React.useCallback(function () {
    ...
    return jsxRuntime.exports.jsx(TextInput$1, __assign({}, props, { type: isPasswordVisible ? 'text' : 'password', rightIsland: showControls
            ? {
                type: exports.InputIslandType.actions,
                content: [{
...
var PasswordInput$1 = React.memo(PasswordInput);
...
var NumberInputCounter = function (_a) {
    ...
    var onIncreaseClick = React.useCallback(function () {
    ...
    var onDecreaseClick = React.useCallback(function () {
...
var NumberInputCounter$1 = React.memo(NumberInputCounter);
...
var NumberInput = function (_a) {
    ...
    var onAllowedCheck = React.useCallback(function (_a) {
    ...
    var onValueChange = React.useCallback(function (_a) {
        var floatValue = _a.floatValue;
        onChange(floatValue);
    }, [onChange]);
...
var CheckboxList = function (_a) {
    var _b = _a.children, children = _b === void 0 ? [] : _b, _c = _a.direction, direction = _c === void 0 ? exports.Direction.horizontal : _c, className = _a.className, _d = _a.limit, limit = _d === void 0 ? 5 : _d, props = __rest$1(_a, ["children", "direction", "className", "limit"]);
    var t = useLocalization();
    var length = Array.isArray(children) ? children.length : 1;
    var _e = React.useState(length <= limit), isExpanded = _e[0], setIsExpanded = _e[1];
    ...
    return jsxRuntime.exports.jsxs("div", __assign({ className: clsx('alt-checkbox-list', className, {
            'alt-checkbox-list--vertical': direction === exports.Direction.vertical
...
var CheckboxList$1 = React.memo(CheckboxList);
...
var ScrollableSelector$1 = React.memo(ScrollableSelector);
...
var Select = function (_a) {
    ...
    return jsxRuntime.exports.jsxs(BasicInput$1, __assign({ hintText: hintText, errorText: errorText, disabled: disabled, size: size }, { children: [(!searchable || (searchable && !isSearchMode)) ? jsxRuntime.exports.jsxs("button", __assign({ ref: selectRef, id: id, disabled: disabled, onClick: onSelectClick, "data-testid": 'alt-test-select', className: clsx('alt-select', classNames.select, {
                    ...
                    'alt-select--disabled': disabled,
                }), type: 'button' }, { children: [jsxRuntime.exports.jsx("div", __assign({ className: clsx('alt-select__value', classNames.currentValue), "data-testid": 'alt-test-select-current-value' }, { children: selectedOption ? React.createElement(ItemComponent, {
                            ...
                            return jsxRuntime.exports.jsxs("div", __assign({ className: 'alt-select-group' }, { children: [(!isSingle && options.length) ? jsxRuntime.exports.jsx("div", __assign({ className: 'alt-select-group__title' }, { children: groupInfo.label })) : null, options.map(function (option, optionIndex) { return (React.createElement(ItemComponent, {
                                        key: optionIndex,
                                        label: option.label,
                                        value: option.value,
...
var Switcher$1 = React.memo(Switcher);
...
var DatePicker = function (_a) {
    var value = _a.value, onChange = _a.onChange, id = _a.id, _b = _a.picker, picker = _b === void 0 ? Picker.day : _b, _c = _a.minDate, minDate = _c === void 0 ? new Date(1900, 0, 0) : _c, _d = _a.maxDate, maxDate = _d === void 0 ? new Date(2050, 13, 0) : _d, _e = _a.disabled, disabled = _e === void 0 ? false : _e, placeholder = _a.placeholder, _f = _a.size, size = _f === void 0 ? exports.Size.medium : _f, hintText = _a.hintText, errorText = _a.errorText, className = _a.className;
    var _g = React.useState(false), isDatePickerVisible = _g[0], setIsDatePickerVisible = _g[1];
    var _h = React.useState(value ? new Date(value.getFullYear(), value.getMonth(), 1) : new Date()), currentMonth = _h[0], setCurrentMonth = _h[1];
    var _j = React.useState(picker), currentView = _j[0], setCurrentView = _j[1];
...
var YearPicker$1 = React.memo(YearPicker);

var MonthPicker = function (_a) {
    var _b = _a.selectedDate, selectedDate = _b === void 0 ? new Date() : _b, onChange = _a.onChange, minYear = _a.minYear, maxYear = _a.maxYear;
    var locale = useThemeContext().locale;
    var monthFormat = React.useMemo(function () {
...
var RadioList = function (_a) {
    var value = _a.value, _b = _a.options, options = _b === void 0 ? [] : _b, _c = _a.disabled, disabled = _c === void 0 ? false : _c, _d = _a.direction, direction = _d === void 0 ? exports.Direction.horizontal : _d, onChange = _a.onChange, name = _a.name;
    return jsxRuntime.exports.jsx("div", __assign({ className: clsx('alt-radio-list', {
            'alt-radio-list--vertical': direction === exports.Direction.vertical
...
var RadioList$1 = React.memo(RadioList);
...
var DataTableSorting = function (_a) {
    ...
    var t = useLocalization();
    var sortKeysOptions = React.useMemo(function () {
    ...
    return jsxRuntime.exports.jsxs("div", __assign({ className: 'alt-data-table-filtering', "data-testid": 'alt-test-datatable-filtering-popup' }, { children: [jsxRuntime.exports.jsx("div", __assign({ className: 'alt-data-table-filtering__title' }, { children: t('data.dataTable.filtering') })), jsxRuntime.exports.jsx(FormGroup$1, { children: filters.map(function (filter, filterIndex) {
                    ...
                    switch (filter.type) {
                        case 'select':
                            ...
                            break;
                        case 'checkboxList':
                            children = jsxRuntime.exports.jsx(CheckboxList$1, __assign({ direction: exports.Direction.vertical }, { children: selectOptions.map(function (checkbox, checkboxIndex) { return (jsxRuntime.exports.jsx(Checkbox$1, __assign({ value: checkbox.value, checked: (currentFilterValue === null || currentFilterValue === void 0 ? void 0 : currentFilterValue.indexOf(checkbox.value)) > -1, onChange: function () { return onChange(checkbox.value); } }, { children: checkbox.label }), checkboxIndex)); }) }));
                            break;
                    }
...
var DataTableHeader = function () {
    ...
    var _b = React.useState(false), isSortVisible = _b[0], setIsSortVisible = _b[1];
    var _c = React.useState(false), isFilterVisible = _c[0], setIsFilterVisible = _c[1];
    var _d = React.useState(false), isSearchVisible = _d[0], setIsSearchVisible = _d[1];
    var t = useLocalization();
    var _e = useWindowSize(), ltePhoneL = _e.ltePhoneL, gtPhoneL = _e.gtPhoneL;
    var currentSortingColumn = React.useMemo(function () {
        if (!sortBy)
            return null;
    ...
    return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [jsxRuntime.exports.jsx("tr", __assign({ className: 'alt-data-table-header-wrapper' }, { children: jsxRuntime.exports.jsx("th", __assign({ colSpan: ltePhoneL ? mobileColumns.length + 1 : columns.length }, { children: jsxRuntime.exports.jsxs("div", __assign({ className: 'alt-data-table-header' }, { children: [(gtPhoneL || (ltePhoneL && !isSearchVisible)) && jsxRuntime.exports.jsxs("div", __assign({ className: 'alt-data-table-header__filters' }, { children: [sortKeys.length > 0 && (jsxRuntime.exports.jsx(Button$1, __assign({ ref: sortRef, leftIcon: ltePhoneL ? null : jsxRuntime.exports.jsx(Icon$1, { i: 'swap_vert' }), variant: exports.ButtonVariant.transparent, onClick: function () { return setIsSortVisible(true); }, isIcon: ltePhoneL }, { children: ltePhoneL
                                            ? jsxRuntime.exports.jsx(Icon$1, { i: 'swap_vert' })
                                            : jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, { children: [sortBy ? t('data.dataTable.sortedBy') : t('data.dataTable.sort'), " ", currentSortingColumn && jsxRuntime.exports.jsx("strong", __assign({ className: 'alt-data-table-header__filter-value' }, { children: currentSortingColumn.label || currentSortingColumn.accessor }))] }) }))), filters.length > 0 && jsxRuntime.exports.jsx(Button$1, __assign({ ref: filterRef, leftIcon: ltePhoneL ? null : jsxRuntime.exports.jsx(Icon$1, { i: 'tune', style: 'outlined' }), variant: exports.ButtonVariant.transparent, onClick: function () { return setIsFilterVisible(true); }, isIcon: ltePhoneL, role: ltePhoneL && appliedFilters.length > 0 && exports.Role.primary }, { children: ltePhoneL
                                ...
                                ?
                                    ltePhoneL
                                        ? jsxRuntime.exports.jsx(Button$1, __assign({ variant: exports.ButtonVariant.transparent, isIcon: true, onClick: function () { return setIsSearchVisible(true); } }, { children: jsxRuntime.exports.jsx(Icon$1, { i: 'search' }) }))
...
var DataTableCell$1 = React.memo(DataTableCell);
...
var DataTableBody = function () {
    ...
    var ltePhoneL = useWindowSize().ltePhoneL;
    var _b = React.useState(-1), selectedRowIndex = _b[0], setSelectedRowIndex = _b[1];
...
var DataTableBody$1 = React.memo(DataTableBody);
...
var DataTableHeaderRow$1 = React.memo(DataTableHeaderRow);
...
var DataTableFooter$1 = React.memo(DataTableFooter);
...
var DataTable = function (_a) {
    ...
    var _k = React.useState(1), page = _k[0], setPage = _k[1];
    var _l = React.useState(''), search = _l[0], setSearch = _l[1];
    var _m = React.useState(), sortBy = _m[0], setSortBy = _m[1];
    var _o = React.useState(exports.Sort.asc), sortType = _o[0], setSortType = _o[1];
    var _p = React.useState([]), appliedFilters = _p[0], setAppliedFilters = _p[1];
...
var Progress$1 = React.memo(Progress);
...
var Heading$1 = React.memo(Heading);
...
var Blockquote$1 = React.memo(Blockquote);
...
var Message = function (_a) {
    var title = _a.title, children = _a.children, _b = _a.role, role = _b === void 0 ? exports.Role.default : _b, IconComponent = _a.IconComponent, className = _a.className;
    return jsxRuntime.exports.jsxs("div", __assign({ className: clsx('alt-message', className, {
            'alt-message--role-primary': role === exports.Role.primary,
            'alt-message--role-success': role === exports.Role.success,
            'alt-message--role-danger': role === exports.Role.danger,
...
exports.Altrone = Altrone;
exports.BasicInput = BasicInput$1;
...
exports.HORIZONTAL_MARGIN = HORIZONTAL_MARGIN;
exports.Heading = Heading$1;
exports.Icon = Icon$1;
exports.Message = Message$1;
exports.Modal = Modal$1;
exports.NavigationList = NavigationList$1;
...
exports.RadioList = RadioList$1;
exports.ScrollableSelector = ScrollableSelector$1;
...
exports.ToolbarGroup = ToolbarGroup$1;
exports.ToolbarSeparator = ToolbarSeparator$1;
exports.VERTICAL_MARGIN = VERTICAL_MARGIN;
exports.ZERO_MARGIN = ZERO_MARGIN;
exports.ZERO_PADDING = ZERO_PADDING;
