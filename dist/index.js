...
var Altrone = function (_a) {
  var children = _a.children,
    _b = _a.theme,
    theme = _b === void 0 ? exports.Theme.light : _b,
    _c = _a.locale,
    locale = _c === void 0 ? 'en-US' : _c,
    _d = _a.lang,
    lang = _d === void 0 ? 'en' : _d,
    _e = _a.style,
    style = _e === void 0 ? {} : _e;
  try {
    // @ts-ignore
  ...
  React.useEffect(function () {
    observerRef.current = new ResizeObserver(function (entries) {
      ...
      (_a = elementRef.current) === null || _a === void 0
        ? void 0
        : _a.classList.add('alt-service--resizing');
      ...
      resizeTimeout.current = setTimeout(function () {
        ...
        (_a = elementRef.current) === null || _a === void 0
          ? void 0
          : _a.classList.remove('alt-service--resizing');
...
var Box = React.forwardRef(function (_a, ref) {
  var _b = _a.margin,
    margin = _b === void 0 ? ZERO_MARGIN : _b,
    _c = _a.padding,
    padding = _c === void 0 ? ZERO_PADDING : _c,
    children = _a.children,
    _d = _a.tagName,
    tagName = _d === void 0 ? 'div' : _d,
    style = _a.style,
    props = __rest$1(_a, ['margin', 'padding', 'children', 'tagName', 'style']);
  ...
  return jsxRuntime.exports.jsx(
    TagName,
    __assign(
      { style: __assign(__assign(__assign({}, marginStyles), paddingStyles), style), ref: ref },
      props,
      { children: children }
    )
  );
...
function getWindowScrollBarX(element) {
  ...
  return (
    getBoundingClientRect$1(getDocumentElement(element)).left + getWindowScroll(element).scrollLeft
  );
}
        ...
        modifier.requires &&
          modifier.requires.forEach(function (requirement) {
            if (
              ...
              console.error(
                format$1(MISSING_DEPENDENCY_ERROR, String(modifier.name), requirement, requirement)
              );
            }
          });
      });
...
var usePopper = function usePopper(referenceElement, popperElement, options) {
  ...
  var popperOptions = React__namespace.useMemo(
    function () {
      var newOptions = {
...
var Icon = function (_a) {
  var i = _a.i,
    ...
    _b = _a.style,
    style = _b === void 0 ? 'outlined' : _b,
    props = __rest$1(_a, ['i', 'size', 'className', 'style']);
  return jsxRuntime.exports.jsx(
    Box$1,
    __assign(
      {
        tagName: 'span',
        className: clsx('alt-icon', 'material-symbols-'.concat(style), className),
...
var Modal = function (_a) {
  ...
  var title = _a.title,
    ...
    onClose = _a.onClose,
    _c = _a.size,
    size = _c === void 0 ? exports.Size.medium : _c,
    _d = _a.fluid,
    fluid = _d === void 0 ? false : _d,
    _e = _a.actions,
    actions = _e === void 0 ? [] : _e,
    _f = _a.showClose,
    showClose = _f === void 0 ? true : _f,
    _g = _a.showCancel,
    showCancel = _g === void 0 ? true : _g,
    _h = _a.closeOnOverlay,
    closeOnOverlay = _h === void 0 ? true : _h,
    _j = _a.reduceMotion,
    reduceMotion = _j === void 0 ? false : _j,
    className = _a.className;
  var _k = useWindowSize(),
    ltePhoneL = _k.ltePhoneL,
    gtPhoneL = _k.gtPhoneL;
  ...
  var onESCPress = React.useCallback(
    function (e) {
      if (e.key === 'Escape') {
        handleClose();
      }
      ...
      __assign(
        {
          ...
          ref: wrapperRef,
          onClick: closeOnOverlay && onBackdropClick
        },
        {
                ...
                children: [
                  title &&
                    jsxRuntime.exports.jsx(
                      'div',
                      __assign(
                        { className: 'alt-modal__title', 'data-testid': 'alt-test-modal-title' },
                        { children: title }
                      )
                    ),
                  showClose &&
                    ...
                    jsxRuntime.exports.jsx(
                      ...
                      __assign(
                        ...
                        { children: jsxRuntime.exports.jsx(Icon$1, { i: 'close' }) }
                      )
                    ),
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign(
                      { className: 'alt-modal__content', 'data-testid': 'alt-test-modal-content' },
                      { children: children }
                    )
                  ),
                  (showCancel || actions.length > 0) &&
                    jsxRuntime.exports.jsxs(
                      'div',
                      __assign(
                        { className: 'alt-modal__footer' },
                        {
                          children: [
                            renderActions(leftActions),
                            jsxRuntime.exports.jsx('div', {
                              className: 'alt-modal__footer-separator'
                            }),
                  ...
                  ltePhoneL &&
                    jsxRuntime.exports.jsx('div', { className: 'alt-modal-wrapper__handle' })
                ]
              }
            )
          )
...
var setPopperWidth = function (state, minWidth) {
  ...
  state.elements.popper.style.width = ''.concat(
...
var FloatingBox = React.forwardRef(function (_a, ref) {
  var targetElement = _a.targetElement,
    onClose = _a.onClose,
    _b = _a.offset,
    offset = _b === void 0 ? 4 : _b,
    _c = _a.placement,
    placement = _c === void 0 ? 'auto' : _c,
    popperProps = _a.popperProps,
    _d = _a.useParentWidth,
    useParentWidth = _d === void 0 ? false : _d,
    minWidth = _a.minWidth,
    _e = _a.maxHeight,
    maxHeight = _e === void 0 ? 'auto' : _e,
    children = _a.children,
    preventClose = _a.preventClose,
    _f = _a.useRootContainer,
    useRootContainer = _f === void 0 ? false : _f,
    _g = _a.mobileBehaviour,
    mobileBehaviour = _g === void 0 ? FloatingBoxMobileBehaviour.default : _g,
    _h = _a.closeOnAnotherFloatingBoxClick,
    closeOnAnotherFloatingBoxClick = _h === void 0 ? false : _h,
    className = _a.className;
  var ltePhoneL = useWindowSize().ltePhoneL;
  var _j = React.useState(null),
    floatingBoxElement = _j[0],
    setFloatingBoxElement = _j[1];
  ...
  var _k = usePopper(
      targetElement,
      floatingBoxElement,
      __assign({ modifiers: modifiers, placement: placement }, popperProps)
    ),
    styles = _k.styles,
  ...
  if (mobileBehaviour === FloatingBoxMobileBehaviour.modal && ltePhoneL) {
    return ReactDOM.createPortal(
      jsxRuntime.exports.jsx(
        Modal$1,
        __assign({ onClose: onClose, showClose: false, showCancel: false }, { children: children })
      ),
      ...
      __assign(
        {
          ...
          style: __assign(__assign({}, styles.popper), { maxHeight: maxHeight }),
...
var Form = function (_a) {
  var className = _a.className,
    ...
    props = __rest$1(_a, ['className', 'children', 'required', 'disabled']);
  return jsxRuntime.exports.jsx(
    FormContext.Provider,
    __assign(
      { value: { required: required, disabled: disabled } },
      {
        children: jsxRuntime.exports.jsx(
          'form',
          __assign(
            { className: clsx('alt-form', className), 'data-testid': 'alt-test-form' },
            props,
            { children: children }
          )
        )
...
var FormGroup = function (_a) {
  var _b = _a.variant,
    variant = _b === void 0 ? exports.FormGroupVariant.default : _b,
    _c = _a.align,
    align = _c === void 0 ? exports.Align.start : _c,
    children = _a.children,
    className = _a.className,
    required = _a.required,
    disabled = _a.disabled,
    _d = _a.weights,
    weights = _d === void 0 ? [] : _d;
  var context = useFormContext();
  var gridTemplateColumns = React.useMemo(
    function () {
...
var FormField = function (_a) {
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: clsx('alt-form-field', className) },
      {
        children: [
          label &&
            jsxRuntime.exports.jsxs(
              'label',
              __assign(
                { htmlFor: id, className: 'alt-form-field__label' },
                {
                  children: [
                    label,
                    ' ',
                    isRequired &&
                      jsxRuntime.exports.jsx(
                        'span',
                        __assign({ className: 'alt-form-field__required-mark' }, { children: '*' })
                      )
                  ]
                }
              )
          ...
          jsxRuntime.exports.jsx(
            'div',
            __assign(
              { className: 'alt-form-field__control' },
              {
                children:
                  typeof children === 'object'
                    ? React.cloneElement(children, { id: id, disabled: disabled })
                    : children
              }
            )
          )
...
var ButtonContainer = function (_a) {
  var _b = _a.direction,
    direction = _b === void 0 ? exports.Direction.horizontal : _b,
    _c = _a.align,
    align = _c === void 0 ? exports.Align.start : _c,
    className = _a.className,
    children = _a.children,
    _d = _a.mobileFluid,
    mobileFluid = _d === void 0 ? false : _d;
  return jsxRuntime.exports.jsx(
    'div',
    __assign(
      {
...
var ContextMenu = function (_a) {
  ...
  var _b = React.useState(null),
    selectedParentItem = _b[0],
    setSelectedParentItem = _b[1];
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-context-menu-list' },
      {
        children: [
          selectedParentItem &&
            __spreadArray(
              [
                jsxRuntime.exports.jsx(ContextMenuItem$1, {
                  icon: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_back_ios' }),
                  title: t('common.back'),
                  onClick: function () {
                    return setSelectedParentItem(null);
                  }
                })
              ],
              selectedParentItem.children.map(function (item, itemIndex) {
                return jsxRuntime.exports.jsx(
                  ContextMenuItem$1,
                  __assign({}, item, {
                    onClick: function () {
                      return onActionClick(item);
                    }
                  }),
                  itemIndex
                );
          ...
          !selectedParentItem &&
            menu.map(function (item, itemIndex) {
              return 'onClick' in item
                ...
                : jsxRuntime.exports.jsx(
                    ContextParentMenuItem$1,
                    __assign({ onClick: onParentItemClick, onClose: onClose }, item),
                    itemIndex
                  );
            })
        ]
    ...
    __assign(
      ...
      },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-context-menu-item__icon' }, { children: action.icon })
          ),
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-context-menu-item__title' }, { children: action.title })
          ),
          action.hint &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-context-menu-item__hint' }, { children: action.hint })
            )
        ]
      }
    )
...
var ContextParentMenuItem = function (_a) {
  var onClick = _a.onClick,
    onClose = _a.onClose,
    action = __rest$1(_a, ['onClick', 'onClose']);
  var gtPhoneL = useWindowSize().gtPhoneL;
  var _b = React.useState(false),
    isChildrenContextMenuVisible = _b[0],
    setIsChildrenContextMenuVisible = _b[1];
        ...
        __assign(
          {
            ...
            onClick: function () {
              if (gtPhoneL) {
                setIsChildrenContextMenuVisible(function (old) {
                  return !old;
                });
              } else {
                onClick(action);
          ...
          },
          {
            children: [
              ...
              jsxRuntime.exports.jsx(
                'div',
                __assign(
                  { className: 'alt-context-menu-item__childrenArrow' },
                  { children: jsxRuntime.exports.jsx(Icon$1, { i: 'keyboard_arrow_right' }) }
                )
              )
            ]
          }
            ...
            __assign(
              {
                ...
                onClose: function () {
                  return setIsChildrenContextMenuVisible(false);
                },
                offset: 8
              },
              {
                children: jsxRuntime.exports.jsx(ContextMenu$1, {
                  onClose: onClose,
...
var Chips = function (_a) {
  ...
  var _c = _a.options,
    ...
    _e = _a.direction,
    direction = _e === void 0 ? exports.Direction.horizontal : _e,
    _f = _a.size,
    size = _f === void 0 ? exports.Size.medium : _f;
  var onChipClick = React.useCallback(
    function (value) {
      var chipIsSelected = values.findIndex(function (chipValue) {
        return value === chipValue;
      });
      if (chipIsSelected > -1) {
        onChange(
          values.filter(function (chipValue) {
            ...
            __assign(
              {
                ...
                onClick: function () {
                  return onChipClick(option.value);
                },
                ...
                children: [
                  isSelected &&
                    jsxRuntime.exports.jsx(
                      'div',
                      __assign(
                        { className: 'alt-chip__icon' },
                        { children: SelectedIcon || jsxRuntime.exports.jsx(Icon$1, { i: 'check' }) }
                      )
                    ),
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign({ className: 'alt-chip__label' }, { children: option.label })
                  )
                ]
              }
            ),
...
var TabList = function (_a) {
  var selected = _a.selected,
    ...
    tabs = _b === void 0 ? [] : _b,
    _c = _a.variant,
    variant = _c === void 0 ? exports.TabListVariant.default : _c,
    _d = _a.fluid,
    fluid = _d === void 0 ? false : _d,
    _e = _a.showCloseButtons,
    showCloseButtons = _e === void 0 ? true : _e,
    _f = _a.showAddTabButton,
    showAddTabButton = _f === void 0 ? true : _f,
    onChange = _a.onChange,
    onCloseTab = _a.onCloseTab,
    onAddTab = _a.onAddTab,
    _g = _a.align,
    align = _g === void 0 ? exports.Align.center : _g;
  var tabListRef = React.useRef(null);
  var selectedTabRef = React.useRef(null);
  var _h = React.useState({}),
    activeBackgroundStyles = _h[0],
    setActiveBackgroundStyles = _h[1];
  var setBackgroundPosition = React.useCallback(
    function () {
  ...
  var onCloseClick = function (e, value) {
    if (variant === exports.TabListVariant.solid && onCloseTab) {
      e.stopPropagation();
      onCloseTab(value);
      var firstValidValue = tabs.find(function (tab) {
        return tab.value !== value && !tab.disabled;
      });
      if (firstValidValue) {
  ...
  return jsxRuntime.exports.jsxs(
    ...
    __assign(
      ...
      {
        children: [
          variant !== exports.TabListVariant.solid &&
            jsxRuntime.exports.jsx('div', {
              className: 'alt-tab-list__active-background',
              style: activeBackgroundStyles
            }),
                        ...
                        __assign(
                          {
                            ...
                            type: 'button',
                            onClick: function (e) {
                              return onCloseClick(e, tab.value);
                            },
          ...
          variant === exports.TabListVariant.solid &&
            ...
            jsxRuntime.exports.jsx(
              ...
              __assign(
                ...
                { children: jsxRuntime.exports.jsx(Icon$1, { i: 'add' }) }
              )
            )
        ]
      }
...
var ToolbarMenu = function (_a) {
  ...
  var _c = React.useState(-1),
    currentMenuIndex = _c[0],
    setCurrentMenuIndex = _c[1];
  var _d = React.useState(null),
    currentMenuItemNode = _d[0],
    setCurrentMenuItemNode = _d[1];
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-toolbar-menu', ref: menuRef, 'data-testid': 'alt-test-toolbarMenu' },
      {
        children: [
          menu.map(function (item, itemIndex) {
            return jsxRuntime.exports.jsx(
              ...
              __assign(
                {
                  ...
                  onClick: function () {
                    return onMenuItemClick(itemIndex);
                  },
                  ...
                  preventClose: function (e) {
                    ...
                    return (
                      ((_a = e.target) === null || _a === void 0
                        ? void 0
                        : _a.closest('.alt-toolbar-menu')) === menuRef.current
                    );
                  }
                },
                {
                  children: jsxRuntime.exports.jsx(ContextMenu$1, {
                    onClose: onCloseSubmenu,
                    menu: menu[currentMenuIndex].submenu || []
                  })
                }
              )
            )
...
var Toolbar = function (_a) {
  var children = _a.children,
    _b = _a.floated,
    floated = _b === void 0 ? false : _b,
    _c = _a.menu,
    menu = _c === void 0 ? [] : _c,
    _d = _a.offset,
    offset = _d === void 0 ? defaultOffset : _d,
    width = _a.width,
    className = _a.className;
      ...
      { value: toolbarRef },
      {
        children: jsxRuntime.exports.jsxs(
          ...
          __assign(
            ...
            {
              children: [
                menu.length > 0 && jsxRuntime.exports.jsx(ToolbarMenu$1, { menu: menu }),
                jsxRuntime.exports.jsx(
                  'div',
                  __assign({ className: 'alt-toolbar__main' }, { children: children })
                )
              ]
            }
          )
    ...
    __assign(
      ...
      },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-toolbar-action__icon' }, { children: icon })
          ),
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-toolbar-action__label' }, { children: label })
          )
        ]
      }
    )
...
var ToolbarGroup = function (_a) {
  var children = _a.children,
    _b = _a.fluid,
    fluid = _b === void 0 ? false : _b,
    _c = _a.align,
    align = _c === void 0 ? exports.Align.center : _c,
    _d = _a.collapsible,
    collapsible = _d === void 0 ? false : _d;
  var _e = React.useState([]),
    context = _e[0],
    setContext = _e[1];
  var _f = React.useState(false),
    isContextVisible = _f[0],
    setIsContextVisible = _f[1];
  ...
  React.useLayoutEffect(
    function () {
      ...
      var buttons = groupRef.current.querySelectorAll(
      ...
      },
      {
        children: [
          !collapsible
            ...
            : children,
          context.length > 0 &&
            jsxRuntime.exports.jsx(ToolbarAction$1, {
              icon: jsxRuntime.exports.jsx(Icon$1, { i: 'expand_more' }),
              label: 'More...',
              className: 'alt-toolbar-action--expand',
              ref: expandButton,
              onClick: function () {
                return setIsContextVisible(true);
              }
            }),
          collapsible &&
            jsxRuntime.exports.jsx(ToolbarAction$1, {
          ...
          collapsible &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-toolbar-group--invisible' }, { children: children })
            ),
          isContextVisible &&
            context.length > 0 &&
            jsxRuntime.exports.jsx(
      ...
      },
      {
        children: [
          icon &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-navigation-list-item__icon' }, { children: icon })
            ),
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-navigation-list-item__label' }, { children: label })
          ),
          submenu.length > 0 &&
            jsxRuntime.exports.jsx(
              'div',
              __assign(
                { className: 'alt-navigation-list-item__arrowIcon' },
                { children: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_forward_ios' }) }
              )
            )
        ]
      }
      ...
      },
      {
        children: [
          icon &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-navigation-list-sub-item__icon' }, { children: icon })
            ),
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-navigation-list-sub-item__label' }, { children: label })
          ),
          submenu.length > 0 &&
            jsxRuntime.exports.jsx(
              'div',
              __assign(
                { className: 'alt-navigation-list-sub-item__arrowIcon' },
                { children: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_forward_ios' }) }
              )
            )
        ]
...
var NavigationList = function (_a) {
  var _b = _a.list,
    ...
    title = _a.title,
    className = _a.className,
    NavigationItemComponent = _a.NavigationItemComponent,
    NavigationSubItemComponent = _a.NavigationSubItemComponent,
    NavigationSubSubItemComponent = _a.NavigationSubSubItemComponent;
  var _c = React.useMemo(
      function () {
        ...
        for (var _i = 0, list_1 = list; _i < list_1.length; _i++) {
          ...
          if (
            (_a = item === null || item === void 0 ? void 0 : item.submenu) === null ||
            _a === void 0
              ? void 0
              : _a.length
          ) {
            for (var _c = 0, _d = item.submenu; _c < _d.length; _c++) {
              ...
              if (
                (_b = subitem === null || subitem === void 0 ? void 0 : subitem.submenu) === null ||
                _b === void 0
                  ? void 0
                  : _b.length
              ) {
    ...
    selectedItem = _c[0],
    selectedSubItem = _c[1],
    selectedSubSubItem = _c[2];
  React.useEffect(
    function () {
      var _a, _b, _c, _d, _e;
      ...
      if (selectedItem && !selectedSubItem) {
        var firstLevelItem = list.find(function (item) {
          return item.value === selectedItem;
        });
        if (
          firstLevelItem &&
          ((_a = firstLevelItem.submenu) === null || _a === void 0 ? void 0 : _a.length)
        ) {
      ...
      if (selectedItem && selectedSubItem && !selectedSubSubItem) {
        ...
        var secondLevelItem =
          (_c = firstLevelItem.submenu) === null || _c === void 0
            ? void 0
            : _c.find(function (item) {
                return item.value === selectedSubItem;
              });
        if (
          secondLevelItem &&
          ((_d = secondLevelItem.submenu) === null || _d === void 0 ? void 0 : _d.length)
        ) {
      ...
      { className: clsx('alt-navigation-list', className) },
      {
        children: [
          title &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-navigation-list__title' }, { children: title })
            ),
          jsxRuntime.exports.jsx(
            'nav',
            __assign(
              { className: 'alt-navigation-list__navigation' },
              {
                    ...
                    React.Fragment,
                    {
                      children: [
                        NavigationItemComponent
                          ? jsxRuntime.exports.jsx(NavigationItemComponent, __assign({}, itemProps))
                          : jsxRuntime.exports.jsx(NavigationListItem$1, __assign({}, itemProps)),
                        selectedItem === item.value &&
                          ((_a = item.submenu) === null || _a === void 0 ? void 0 : _a.length) >
                            0 &&
                          jsxRuntime.exports.jsx(
                            'div',
                            __assign(
                              ...
                              {
                                children:
                                  (_b = item.submenu) === null || _b === void 0
                                    ? void 0
                                    : _b.map(function (subitem, subitemIndex) {
                                        var _a, _b;
                                        var subItemProps = __assign(
                                          {
                                            selected: subitem.value === selectedSubItem,
                                            onClick: function () {
                                              return onChange(subitem.value);
                                            }
                                          },
                                          subitem
                                        );
                                          ...
                                          React.Fragment,
                                          {
                                            children: [
                                              NavigationSubItemComponent
                                                ? jsxRuntime.exports.jsx(
                                                    NavigationSubItemComponent,
                                                    __assign({}, subItemProps)
                                                  )
                                                : jsxRuntime.exports.jsx(
                                                    NavigationListSubItem$1,
                                                    __assign({}, subItemProps)
                                                  ),
                                              selectedSubItem === subitem.value &&
                                                ((_a = subitem.submenu) === null || _a === void 0
                                                  ? void 0
                                                  : _a.length) > 0 &&
                                                jsxRuntime.exports.jsx(
                                                  'div',
...
var ButtonComponents = ['button', 'a'];
var Button = React.forwardRef(function (_a, ref) {
  var _b;
  var children = _a.children,
    _c = _a.role,
    role = _c === void 0 ? exports.Role.default : _c,
    _d = _a.variant,
    variant = _d === void 0 ? exports.ButtonVariant.default : _d,
    href = _a.href,
    className = _a.className,
    _e = _a.fluid,
    fluid = _e === void 0 ? false : _e,
    leftIcon = _a.leftIcon,
    rightIcon = _a.rightIcon,
    _f = _a.size,
    size = _f === void 0 ? exports.Size.medium : _f,
    _g = _a.dropdown,
    dropdown = _g === void 0 ? [] : _g,
    onClick = _a.onClick,
    _h = _a.type,
    type = _h === void 0 ? 'button' : _h,
    _j = _a.isIcon,
    isIcon = _j === void 0 ? false : _j,
    props = __rest$1(_a, [
      'children',
      'role',
      'variant',
  ...
  return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
    children: [
      jsxRuntime.exports.jsxs(
        ...
        __assign(
          {
            tagName: ButtonComponents[href ? 1 : 0],
            className: clsx(
              'alt-button',
              className,
              ((_b = {}),
              (_b['alt-button--role-'.concat(role)] = role !== exports.Role.default),
              (_b['alt-button--variant-'.concat(variant)] =
                variant !== exports.ButtonVariant.default),
          ...
          props,
          {
            children: [
              leftIcon
                ? jsxRuntime.exports.jsx(
                    'span',
                    __assign({ className: 'alt-button__leftIcon' }, { children: leftIcon })
                  )
                : null,
              children,
              rightIcon
                ? jsxRuntime.exports.jsx(
                    'span',
                    __assign({ className: 'alt-button__rightIcon' }, { children: rightIcon })
                  )
                : null
            ]
          }
      ...
      },
      {
        children: [
          ...
          errorText &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-basic-input__error-text' }, { children: errorText })
            ),
          hintText &&
            jsxRuntime.exports.jsx(
              'div',
              __assign({ className: 'alt-basic-input__hint-text' }, { children: hintText })
            )
        ]
      }
    )
  ...
  return React.useMemo(
    function () {
      ...
      if (text || type === exports.InputIslandType.text) {
        return jsxRuntime.exports.jsx(
          'div',
          __assign({ className: 'alt-text-input__text-island' }, { children: text || content })
        );
      } else if (icon || type === exports.InputIslandType.icon) {
        return jsxRuntime.exports.jsx(
          'div',
          __assign({ className: 'alt-text-input__icon-island' }, { children: icon || content })
        );
      } else if (type === exports.InputIslandType.actions) {
        return jsxRuntime.exports.jsx(
          'div',
          __assign(
            { className: 'alt-text-input__actions-island' },
            {
              children:
                content === null || content === void 0
                  ? void 0
                  : content.map(function (action, actionIndex) {
                      return jsxRuntime.exports.jsx(
                        'button',
                        __assign(
                          {
        ...
        return jsxRuntime.exports.jsx(
          'div',
          __assign({ className: 'alt-text-input__components-island' }, { children: content })
        );
      }
      return null;
    },
...
var TextInput = React.forwardRef(function (_a, ref) {
  ...
  var _b = _a.classNames,
    ...
    prefix = _a.prefix,
    leftIcon = _a.leftIcon,
    leftIsland = _a.leftIsland,
    suffix = _a.suffix,
    rightIcon = _a.rightIcon,
    rightIsland = _a.rightIsland,
    style = _a.style,
  ...
  var _d = useBoundingclientrect(wrapperRef) || {},
    _e = _d.left,
    wrapperLeft = _e === void 0 ? 0 : _e,
    _f = _d.right,
    wrapperRight = _f === void 0 ? 0 : _f;
  var _g = (useBoundingclientrect(leftIslandRef) || {}).width,
    leftIslandWidth = _g === void 0 ? 0 : _g;
  var _h = (useBoundingclientrect(rightIslandRef) || {}).width,
    rightIslandWidth = _h === void 0 ? 0 : _h;
  var _j = React.useState(DEFAULT_HORIZONTAL_PADDING),
    leftPadding = _j[0],
    setLeftPadding = _j[1];
  var _k = React.useState(DEFAULT_HORIZONTAL_PADDING),
    rightPadding = _k[0],
    setRightPadding = _k[1];
  React.useEffect(
    function () {
      if (_leftIsland) {
  ...
  return jsxRuntime.exports.jsx(
    BasicInput$1,
    __assign(
      { hintText: hintText, errorText: errorText, disabled: disabled, size: size },
      {
        children: jsxRuntime.exports.jsxs(
          'div',
          __assign(
              ...
              children: [
                ...
                _leftIsland &&
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign(
                      { className: 'alt-text-input__left-island', ref: leftIslandRef },
                      { children: _leftIsland }
                    )
                  ),
                _rightIsland &&
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign(
                      { className: 'alt-text-input__right-island', ref: rightIslandRef },
                      { children: _rightIsland }
                    )
                  ),
                required &&
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign({ className: 'alt-text-input__required-mark' }, { children: '*' })
                  )
              ]
            }
          )
...
var PasswordInput = function (_a) {
  var _b = _a.showControls,
    showControls = _b === void 0 ? true : _b,
    rightIsland = _a.rightIsland,
    props = __rest$1(_a, ['showControls', 'rightIsland']);
  var _c = React.useState(false),
    isPasswordVisible = _c[0],
    setIsPasswordVisible = _c[1];
  var togglePasswordVisible = React.useCallback(function () {
    setIsPasswordVisible(function (old) {
      return !old;
    });
  }, []);
  return jsxRuntime.exports.jsx(
            ...
            content: [
              {
                ...
                icon: isPasswordVisible
                  ? jsxRuntime.exports.jsx(Icon$1, { i: 'visibility_off' })
                  : jsxRuntime.exports.jsx(Icon$1, { i: 'visibility' }),
...
var NumberInputCounter = function (_a) {
  var value = _a.value,
    ...
    _b = _a.step,
    step = _b === void 0 ? 1 : _b;
  var onIncreaseClick = React.useCallback(
    function () {
  ...
  var onDecreaseClick = React.useCallback(
    function () {
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-number-input-counter' },
      {
        children: [
          jsxRuntime.exports.jsx(
            'button',
            __assign(
              ...
              { children: jsxRuntime.exports.jsx(Icon$1, { i: 'expand_less' }) }
            )
          ),
          jsxRuntime.exports.jsx(
            'button',
            __assign(
              ...
              { children: jsxRuntime.exports.jsx(Icon$1, { i: 'expand_more' }) }
            )
          )
        ]
      }
...
function NumberFormatBase(props) {
  ...
  var getNewCaretPosition = function (inputValue, newFormattedValue, caretPos) {
    ...
    var updatedCaretPos = getCaretPosition(
      newFormattedValue,
      formattedValue,
      inputValue,
      caretPos,
  ...
  if (displayType === 'text') {
    ...
    return React__default['default'].createElement(
      CustomInput,
      Object.assign({}, inputProps, { ref: getInputRef })
    );
  }
  return React__default['default'].createElement(
    'input',
...
function useNumericFormat(props) {
  ...
  if (!isNil(value)) {
    _valueIsNumericString =
      valueIsNumericString !== null && valueIsNumericString !== void 0
        ? valueIsNumericString
        : typeof value === 'number';
...
function NumericFormat(props) {
  ...
  return React__default['default'].createElement(
    NumberFormatBase,
    Object.assign({}, numericFormatProps)
  );
}
...
var NumberInput = function (_a) {
  var _b = _a.value,
    value = _b === void 0 ? 0 : _b,
    _c = _a.showControls,
    showControls = _c === void 0 ? true : _c,
    rightIsland = _a.rightIsland,
    onChange = _a.onChange,
    _d = _a.allowNegative,
    allowNegative = _d === void 0 ? false : _d,
    _e = _a.allowLeadingZeros,
    allowLeadingZeros = _e === void 0 ? false : _e,
    _f = _a.decimalSeparator,
    decimalSeparator = _f === void 0 ? ',' : _f,
    _g = _a.digitsAfterDecimal,
    digitsAfterDecimal = _g === void 0 ? 0 : _g,
    _h = _a.step,
    step = _h === void 0 ? 1 : _h,
    min = _a.min,
    max = _a.max,
  ...
  var onAllowedCheck = React.useCallback(
    function (_a) {
  ...
  var onValueChange = React.useCallback(
    function (_a) {
      var floatValue = _a.floatValue;
      onChange(floatValue);
    },
      ...
      props,
      {
        rightIsland: showControls
          ? {
              ...
              content: jsxRuntime.exports.jsx(NumberInputCounter$1, {
                value: value,
                onChange: onChange,
                step: step,
                min: min,
          ...
          : rightIsland,
        Component: jsxRuntime.exports.jsx(NumericFormat, {
          value: value,
        ...
        step: (1 / Math.pow(10, digitsAfterDecimal)).toString()
      }
    )
  );
};
...
var Checkbox = function (_a) {
  var disabled = _a.disabled,
    ...
    _c = _a.danger,
    danger = _c === void 0 ? false : _c,
    children = _a.children,
    CheckIconComponent = _a.CheckIconComponent,
    className = _a.className,
    onChange = _a.onChange,
    hintText = _a.hintText,
    errorText = _a.errorText,
  ...
  return jsxRuntime.exports.jsx(
    BasicInput$1,
    __assign(
      { hintText: hintText, errorText: errorText, disabled: disabled },
      {
        children: jsxRuntime.exports.jsxs(
          'label',
          __assign(
            ...
            },
            {
              children: [
                jsxRuntime.exports.jsx(
                  'input',
                  __assign(
                    { id: checkboxId, type: 'checkbox', checked: checked, disabled: disabled },
                    props,
                    {
                ...
                jsxRuntime.exports.jsxs(
                  'div',
                  __assign(
                    { className: 'alt-checkbox__control' },
                    {
                      children: [
                        checked
                          ? jsxRuntime.exports.jsx(
                              'div',
                              __assign(
                                { className: 'alt-checkbox__icon' },
                                {
                                  children:
                                    CheckIconComponent ||
                                    jsxRuntime.exports.jsx(Icon$1, { i: 'check' })
                                }
                              )
                            )
                          : null,
                        children &&
                          jsxRuntime.exports.jsx(
                            'div',
                            __assign({ className: 'alt-checkbox__label' }, { children: children })
                          )
                      ]
                    }
                  )
...
var CheckboxList = function (_a) {
  var _b = _a.children,
    ...
    _c = _a.direction,
    direction = _c === void 0 ? exports.Direction.horizontal : _c,
    className = _a.className,
    _d = _a.limit,
    limit = _d === void 0 ? 5 : _d,
    props = __rest$1(_a, ['children', 'direction', 'className', 'limit']);
  var t = useLocalization();
  var length = Array.isArray(children) ? children.length : 1;
  var _e = React.useState(length <= limit),
    isExpanded = _e[0],
    setIsExpanded = _e[1];
        ...
        children: [
          ...
          length > limit &&
            jsxRuntime.exports.jsx(
              'div',
              __assign(
                { className: 'alt-checkbox-list__actions' },
                {
                  children: jsxRuntime.exports.jsx(
                    'button',
                    __assign(
                      { className: 'alt-checkbox-list__expand', onClick: onExpandClick },
                      { children: isExpanded ? t('common.less') : t('common.more') }
                    )
                  )
                }
              )
...
var SelectOption = function (_a) {
  var label = _a.label,
    ...
    className = _a.className,
    _d = _a.inSelectHeader,
    inSelectHeader = _d === void 0 ? false : _d;
      ...
      },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign(
              { className: 'alt-select-option__icon' },
              { children: selected ? jsxRuntime.exports.jsx(Icon$1, { i: 'check' }) : null }
            )
          ),
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-select-option__label' }, { children: label })
          )
        ]
      }
    )
...
var ScrollableSelector = function (_a) {
  var value = _a.value,
    ...
    _e = _a.align,
    align = _e === void 0 ? exports.Align.center : _e,
    onChange = _a.onChange,
    className = _a.className;
  ...
  React.useEffect(
    function () {
      ...
      (_a = selectorRef.current) === null || _a === void 0
        ? void 0
        : _a.scrollTo({
            top: 34 * valueIndex,
            behavior: 'smooth'
...
var SelectPlaceholder = function (_a) {
  ...
  return jsxRuntime.exports.jsx(
    'div',
    __assign({ className: 'alt-select-placeholder' }, { children: children })
  );
};
...
var Select = function (_a) {
  var value = _a.value,
    ...
    searchFunc = _a.searchFunc,
    _d = _a.ItemComponent,
    ItemComponent = _d === void 0 ? SelectOption$1 : _d,
    _e = _a.disabled,
    ...
    hintText = _a.hintText,
    errorText = _a.errorText;
  var _h = useWindowSize(),
    ltePhoneL = _h.ltePhoneL,
    gtPhoneL = _h.gtPhoneL;
  var t = useLocalization();
  var _j = React.useState(false),
    isSelectVisible = _j[0],
    setIsSelectVisible = _j[1];
  var _k = React.useState(false),
    isSearchMode = _k[0],
    setIsSearchMode = _k[1];
  ...
  var _m = React.useMemo(
      function () {
        ...
        if (searchable && searchTerm) {
          if (searchFunc) {
            filteredOptions = filteredOptions.filter(function (option) {
              return searchFunc(searchTerm, option);
            });
          } else {
            filteredOptions = filteredOptions.filter(function (option) {
              return (
        ...
        var _loop_1 = function (option) {
          if (option.parent) {
            if (result[option.parent]) {
              ...
              var parentData = parents.find(function (p) {
                return p.value === option.parent;
              }) || { label: option.parent, value: option.parent };
        ...
        var parentKeys = Object.keys(result).filter(function (pK) {
          return pK !== DEFAULT_KEY;
        });
      ...
      { hintText: hintText, errorText: errorText, disabled: disabled, size: size },
      {
        children: [
          !searchable || (searchable && !isSearchMode)
                        ...
                        __assign(
                          ...
                          },
                          {
                            children: selectedOption
                              ...
                              : jsxRuntime.exports.jsx(SelectPlaceholder$1, {
                                  children: placeholder || t('form.select.placeholder')
                                })
                          }
                        )
                      ),
            ...
            : jsxRuntime.exports.jsx(TextInput$1, {
                ref: selectRef,
                placeholder: 'Search...',
                value: searchTerm,
                onChange: setSearchTerm,
                rightIcon: jsxRuntime.exports.jsx(Icon$1, { i: 'search' }),
                onBlur: onInputBlur,
                autoFocus: true
              }),
          isSelectVisible &&
                    ...
                    gtPhoneL &&
                      jsxRuntime.exports.jsx(
                        ...
                        __assign(
                          ...
                          {
                            children: parentKeys.map(function (
                              groupValue,
                              groupIndex,
                              groupedValueKeys
                            ) {
                              var group = groupedItems[groupValue];
                              var groupInfo = group[0],
                                options = group.slice(1);
                              var isSingle = groupedValueKeys.length === 1;
                              return jsxRuntime.exports.jsxs(
                                'div',
                                __assign(
                                  { className: 'alt-select-group' },
                                  {
                                    children: [
                                      !isSingle && options.length
                                        ? jsxRuntime.exports.jsx(
                                            'div',
                                            __assign(
                                              { className: 'alt-select-group__title' },
                                              { children: groupInfo.label }
                                            )
                                          )
                                        : null,
                      ...
                      jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
                        children: [
                          jsxRuntime.exports.jsx(
                            'div',
                            __assign(
                              { className: 'alt-select-menu__title' },
                              { children: t('form.select.placeholder') }
                            )
                          ),
                          jsxRuntime.exports.jsx(ScrollableSelector$1, {
                          ...
                          jsxRuntime.exports.jsx(
                            ...
                            __assign(
                              {
                                role: exports.Role.primary,
                                onClick: function () {
                                  return setIsSelectVisible(false);
                                },
                                fluid: true
                              },
...
var Switcher = function (_a) {
  ...
  return jsxRuntime.exports.jsx(
    BasicInput$1,
    __assign(
      { errorText: errorText, hintText: hintText },
      {
        children: jsxRuntime.exports.jsxs(
          'label',
          __assign(
            ...
            },
            {
              children: [
                jsxRuntime.exports.jsx(
                  'input',
                  __assign({ id: switcherId, type: 'checkbox', disabled: disabled }, props, {
                ...
                jsxRuntime.exports.jsx('div', { className: 'alt-switcher__indicator' }),
                children &&
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign({ className: 'alt-switcher__label' }, { children: children })
                  )
              ]
            }
          )
...
var DatePicker = function (_a) {
  var value = _a.value,
    ...
    id = _a.id,
    _b = _a.picker,
    picker = _b === void 0 ? Picker.day : _b,
    _c = _a.minDate,
    minDate = _c === void 0 ? new Date(1900, 0, 0) : _c,
    _d = _a.maxDate,
    maxDate = _d === void 0 ? new Date(2050, 13, 0) : _d,
    _e = _a.disabled,
    disabled = _e === void 0 ? false : _e,
    placeholder = _a.placeholder,
    _f = _a.size,
  ...
  var _g = React.useState(false),
    isDatePickerVisible = _g[0],
    setIsDatePickerVisible = _g[1];
  var _h = React.useState(value ? new Date(value.getFullYear(), value.getMonth(), 1) : new Date()),
    currentMonth = _h[0],
    setCurrentMonth = _h[1];
  var _j = React.useState(picker),
    currentView = _j[0],
    setCurrentView = _j[1];
  ...
  var valueDateFormat = new Intl.DateTimeFormat(
    locale,
    picker === Picker.year
      ? {
          year: 'numeric'
  ...
  var onNextMonthClick = function () {
    setCurrentMonth(function (old) {
      return new Date(old.getFullYear(), old.getMonth() + 1, old.getDate());
    });
  };
  ...
  var onCurrentDateClick = function () {
    setCurrentView(function (view) {
      return view === Picker.day ? Picker.month : Picker.day;
    });
  };
  React.useEffect(
    function () {
  ...
  return jsxRuntime.exports.jsxs(
    BasicInput$1,
    __assign(
      { disabled: disabled, hintText: hintText, errorText: errorText, size: size },
      {
        children: [
          jsxRuntime.exports.jsxs(
            'button',
            __assign(
              {
                ...
                ref: inputRef,
                onClick: function () {
                  return setIsDatePickerVisible(!isDatePickerVisible);
                },
                ...
                children: [
                  value
                    ? jsxRuntime.exports.jsx(
                        'div',
                        __assign(
                          { className: 'alt-date-picker__value' },
                          { children: valueDateFormat.format(value) }
                        )
                      )
                    : jsxRuntime.exports.jsx(
                        'div',
                        __assign(
                          { className: 'alt-date-picker__placeholder' },
                          { children: placeholder || t('form.datePicker.placeholder') }
                        )
                      ),
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign(
                      { className: 'alt-date-picker__icon' },
                      { children: jsxRuntime.exports.jsx(Icon$1, { i: 'calendar_month' }) }
                    )
                  )
                ]
              }
                ...
                },
                {
                  children: [
                    jsxRuntime.exports.jsxs(
                      'div',
                      __assign(
                        { className: 'alt-date-picker__header' },
                        {
                          children: [
                            !ltePhoneL &&
                              picker === Picker.day &&
                              jsxRuntime.exports.jsx(
                                ...
                                __assign(
                                  ...
                                  { children: currentMonthFormat.format(currentMonth) }
                                )
                              ),
                            ltePhoneL &&
                              picker === Picker.day &&
                              jsxRuntime.exports.jsx(
                                'div',
                                __assign(
                                  { className: 'alt-date-picker__title' },
                                  { children: currentMonthFormat.format(currentMonth) }
                                )
                              ),
                            picker === Picker.month &&
                              jsxRuntime.exports.jsx(
                                ...
                                __assign(
                                  { className: 'alt-date-picker__title' },
                                  { children: t('form.datePicker.chooseMonth') }
                                )
                              ),
                            picker === Picker.year &&
                              jsxRuntime.exports.jsx(
                                ...
                                __assign(
                                  { className: 'alt-date-picker__title' },
                                  { children: t('form.datePicker.chooseYear') }
                                )
                              ),
                            !ltePhoneL &&
                              currentView === Picker.day &&
                              jsxRuntime.exports.jsxs(
                                'div',
                                __assign(
                                  { className: 'alt-date-picker__navigation' },
                                  {
                                    children: [
                                      jsxRuntime.exports.jsx(
                                        'button',
                    ...
                    currentView === Picker.day &&
                      jsxRuntime.exports.jsx(Calendar$1, {
                        currentMonth: currentMonth,
                        selectedDate: value || today,
                        onChange: onChange
                      }),
                    currentView === Picker.month &&
                      jsxRuntime.exports.jsx(MonthPicker$1, {
                        currentMonth: currentMonth,
                        selectedDate: value || today,
                        onChange: onChange,
                    ...
                    currentView === Picker.year &&
                      jsxRuntime.exports.jsx(YearPicker$1, {
                        currentMonth: currentMonth,
                        selectedDate: value || today,
                        onChange: onChange,
                        minYear: minDate.getFullYear(),
                    ...
                    !ltePhoneL &&
                      jsxRuntime.exports.jsxs(
                        'div',
                        __assign(
                          { className: 'alt-date-picker__footer' },
                          {
                            children: [
                              currentView === Picker.day &&
                                jsxRuntime.exports.jsx(
                                  ...
                                  __assign(
                                    ...
                                    { children: t('form.datePicker.today') }
                                  )
                                ),
                              currentView === Picker.month &&
                                jsxRuntime.exports.jsx(
                                  ...
                                  __assign(
                                    ...
                                    { children: t('form.datePicker.currentMonth') }
                                  )
                                ),
                              jsxRuntime.exports.jsx(
                                Button$1,
                              ...
                              currentView === Picker.day &&
                                jsxRuntime.exports.jsx(
                                  ...
                                  __assign(
                                    ...
                                    {
                                      children: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_back' })
                                    }
                                  )
                                ),
                              currentView === Picker.day &&
                                  ...
                                  __assign(
                                    {
                                      ...
                                      leftIcon: jsxRuntime.exports.jsx(Icon$1, { i: 'today' })
                                    },
                                    {
                                      children:
                                        currentView === Picker.day
                                  ...
                                  __assign(
                                    {
                                      ...
                                      className: 'alt-date-picker__mobileApply',
                                      role: exports.Role.primary,
                                      leftIcon: jsxRuntime.exports.jsx(Icon$1, {
                                        i: 'arrow_back_ios'
                                      })
                                    },
...
var Calendar = function (_a) {
      ...
      for (var day = firstDay.getDate(); day <= lastDay.getDate(); day++) {
        ...
        if (day === 1) {
          ...
          for (var nextMonth = 1; nextMonth <= 7 - lastDay.getDay(); nextMonth++) {
            var nextMonthCurrentDate = new Date(
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-calendar', 'data-testid': 'alt-test-calendar' },
      {
        children: [
          weekdayDateMap.map(function (day, dayIndex) {
            return jsxRuntime.exports.jsx(
              'span',
              __assign(
                {
                ...
                { children: weekdayDateFormat.format(day) }
              ),
              dayIndex
            );
          }),
...
var YearPicker = function (_a) {
  ...
  return jsxRuntime.exports.jsx(
    'div',
    __assign(
      { className: 'alt-year-picker', 'data-testid': 'alt-test-year-picker' },
      {
        children: jsxRuntime.exports.jsx(ScrollableSelector$1, {
...
var MonthPicker = function (_a) {
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-month-picker', 'data-testid': 'alt-test-month-picker' },
      {
        children: [
          jsxRuntime.exports.jsx(ScrollableSelector$1, {
            value: selectedDate.getMonth(),
            align: exports.Align.end,
            options: months,
            onChange: onSelectMonth
          }),
          jsxRuntime.exports.jsx('div', { className: 'alt-month-picker__separator' }),
          jsxRuntime.exports.jsx(ScrollableSelector$1, {
            value: selectedDate.getFullYear(),
...
var RadioList = function (_a) {
  var value = _a.value,
    ...
    disabled = _c === void 0 ? false : _c,
    _d = _a.direction,
    direction = _d === void 0 ? exports.Direction.horizontal : _d,
    onChange = _a.onChange,
    name = _a.name;
  return jsxRuntime.exports.jsx(
    'div',
...
var Radio = function (_a) {
  ...
  return jsxRuntime.exports.jsxs(
    'label',
    __assign(
      { htmlFor: id, className: 'alt-radio', 'data-testid': 'alt-test-radio' },
      {
        children: [
          ...
          jsxRuntime.exports.jsxs(
            'div',
            __assign(
              { className: 'alt-radio__control' },
              {
                children: [
                  jsxRuntime.exports.jsx('div', { className: 'alt-radio__icon' }),
                  jsxRuntime.exports.jsx(
                    'div',
                    __assign({ className: 'alt-radio__label' }, { children: label })
                  )
                ]
              }
            )
...
var Textarea = function (_a) {
  ...
  return jsxRuntime.exports.jsx(
    BasicInput$1,
    __assign(
      { hintText: hintText, errorText: errorText, size: size, disabled: disabled },
      {
        children: jsxRuntime.exports.jsxs(
          'div',
          __assign(
...
var DataTableSorting = function (_a) {
  ...
  var _b = useDataTableContext(),
    columns = _b.columns,
    sortKeys = _b.sortKeys,
    sortBy = _b.sortBy,
    sortType = _b.sortType,
    setSortType = _b.setSortType,
    setSortBy = _b.setSortBy;
  var t = useLocalization();
  var sortKeysOptions = React.useMemo(
    function () {
      return sortKeys.map(function (keyName) {
        var option = columns.find(function (column) {
          return column.accessor === keyName;
        });
        return {
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-data-table-sorting', 'data-testid': 'alt-test-datatable-sorting' },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign(
              { className: 'alt-data-table-sorting__title' },
              { children: t('data.dataTable.sorting') }
            )
          ),
          jsxRuntime.exports.jsxs(FormGroup$1, {
            children: [
              jsxRuntime.exports.jsx(
                FormField$1,
                __assign(
                  { label: t('data.dataTable.field') },
                  {
              ...
              jsxRuntime.exports.jsx(
                FormField$1,
                __assign(
                  { label: t('data.dataTable.direction') },
                  {
                    children: jsxRuntime.exports.jsx(RadioList$1, {
                      value: sortType,
                      direction: exports.Direction.vertical,
          ...
          jsxRuntime.exports.jsx(
            'div',
            __assign(
              { className: 'alt-data-table-sorting__footer' },
              {
                children: jsxRuntime.exports.jsxs(
                  ButtonContainer$1,
                  __assign(
                    { align: exports.Align.end, direction: exports.Direction.vertical },
                    {
                      children: [
                        sortBy &&
                          jsxRuntime.exports.jsx(
                            ...
                            __assign(
                              ...
                              { children: t('data.dataTable.resetSorting') }
                            )
                          ),
                        jsxRuntime.exports.jsx(
                          Button$1,
                          __assign(
                            { role: exports.Role.primary, onClick: onClose },
                            { children: t('common.apply') }
                          )
                        )
                      ]
...
var DataTableFiltering = function (_a) {
  ...
  var _b = useDataTableContext(),
    filters = _b.filters,
    initialData = _b.initialData,
    appliedFilters = _b.appliedFilters,
    setAppliedFilters = _b.setAppliedFilters;
  var t = useLocalization();
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      {
        className: 'alt-data-table-filtering',
        'data-testid': 'alt-test-datatable-filtering-popup'
      },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign(
              { className: 'alt-data-table-filtering__title' },
              { children: t('data.dataTable.filtering') }
            )
          ),
          jsxRuntime.exports.jsx(FormGroup$1, {
            children: filters.map(function (filter, filterIndex) {
              var _a, _b;
              var options = new Set();
              initialData.forEach(function (row) {
                options.add(row[filter.accessor]);
              });
              var selectOptions = Array.from(options).map(function (variant) {
                return {
                  label: variant.toString(),
                  value: variant
                };
              });
              var currentFilterIndex = appliedFilters.findIndex(function (appliedFilter) {
                return appliedFilter.accessor === filter.accessor;
              });
              var currentFilterValue = null;
              switch (filter.type) {
                case 'select':
                  currentFilterValue =
                    ((_a = appliedFilters[currentFilterIndex]) === null || _a === void 0
                      ? void 0
                      : _a.value) || null;
                  break;
                case 'checkboxList':
                  currentFilterValue =
                    ((_b = appliedFilters[currentFilterIndex]) === null || _b === void 0
                      ? void 0
                      : _b.value) || [];
                  break;
              }
              var onChange = function (value) {
                ...
                if (filter.type === 'select') {
                  ...
                  if (currentFilterIndex === -1) {
                    ...
                    if (
                      ((_a = _filters[currentFilterIndex].value) === null || _a === void 0
                        ? void 0
                        : _a.indexOf(value)) > -1
                    ) {
                      _filters[currentFilterIndex].value = _filters[
                        currentFilterIndex
                      ].value.filter(function (filterValue) {
                        return filterValue !== value;
                      });
                      if (_filters[currentFilterIndex].value.length === 0) {
                        _filters = _filters.filter(function (_, filterIndex) {
                          return filterIndex !== currentFilterIndex;
                        });
                      }
                    } else {
                ...
                case 'checkboxList':
                  children = jsxRuntime.exports.jsx(
                    ...
                    __assign(
                      { direction: exports.Direction.vertical },
                      {
                        children: selectOptions.map(function (checkbox, checkboxIndex) {
                          return jsxRuntime.exports.jsx(
                            Checkbox$1,
                            __assign(
                              {
                                ...
                                checked:
                                  (currentFilterValue === null || currentFilterValue === void 0
                                    ? void 0
                                    : currentFilterValue.indexOf(checkbox.value)) > -1,
                                onChange: function () {
                                  return onChange(checkbox.value);
                                }
                              },
              ...
              return jsxRuntime.exports.jsx(
                FormField$1,
                __assign({ label: filter.label || filter.accessor }, { children: children }),
                filterIndex
              );
            })
          }),
                  ...
                  appliedFilters.length > 0 &&
                    jsxRuntime.exports.jsx(
                      ...
                      __assign(
                        ...
                        { children: t('data.dataTable.resetFilters') }
                      )
                    ),
                  jsxRuntime.exports.jsx(
                    Button$1,
...
var DataTableHeader = function () {
  var _a = useDataTableContext(),
    ...
    filters = _a.filters,
    searchBy = _a.searchBy,
    mobileColumns = _a.mobileColumns;
  var _b = React.useState(false),
    isSortVisible = _b[0],
    setIsSortVisible = _b[1];
  var _c = React.useState(false),
    isFilterVisible = _c[0],
    setIsFilterVisible = _c[1];
  var _d = React.useState(false),
    isSearchVisible = _d[0],
    setIsSearchVisible = _d[1];
  var t = useLocalization();
  var _e = useWindowSize(),
    ltePhoneL = _e.ltePhoneL,
    gtPhoneL = _e.gtPhoneL;
  var currentSortingColumn = React.useMemo(
    function () {
  ...
  return jsxRuntime.exports.jsxs(jsxRuntime.exports.Fragment, {
    children: [
      jsxRuntime.exports.jsx(
        'tr',
        __assign(
          { className: 'alt-data-table-header-wrapper' },
          {
            children: jsxRuntime.exports.jsx(
              'th',
              __assign(
                { colSpan: ltePhoneL ? mobileColumns.length + 1 : columns.length },
                {
                  children: jsxRuntime.exports.jsxs(
                    'div',
                    __assign(
                      { className: 'alt-data-table-header' },
                      {
                        children: [
                          (gtPhoneL || (ltePhoneL && !isSearchVisible)) &&
                            jsxRuntime.exports.jsxs(
                              'div',
                              __assign(
                                { className: 'alt-data-table-header__filters' },
                                {
                                  children: [
                                    sortKeys.length > 0 &&
                                      jsxRuntime.exports.jsx(
                                        ...
                                        __assign(
                                          {
                                            ...
                                            variant: exports.ButtonVariant.transparent,
                                            onClick: function () {
                                              return setIsSortVisible(true);
                                            },
                                            isIcon: ltePhoneL
                                          },
                                          {
                                            children: ltePhoneL
                                              ...
                                              : jsxRuntime.exports.jsxs(
                                                  jsxRuntime.exports.Fragment,
                                                  {
                                                    children: [
                                                      sortBy
                                                        ? t('data.dataTable.sortedBy')
                                                        : t('data.dataTable.sort'),
                                                      ' ',
                                                      currentSortingColumn &&
                                                        jsxRuntime.exports.jsx(
                                                          ...
                                                          __assign(
                                                            {
                                                              className:
                                                                'alt-data-table-header__filter-value'
                                                            },
                                                            {
                                                              children:
                                                                currentSortingColumn.label ||
                                        ...
                                        __assign(
                                          {
                                            ...
                                            leftIcon: ltePhoneL
                                              ? null
                                              : jsxRuntime.exports.jsx(Icon$1, {
                                                  i: 'tune',
                                                  style: 'outlined'
                                                }),
                                            variant: exports.ButtonVariant.transparent,
                                            onClick: function () {
                                              return setIsFilterVisible(true);
                                            },
                                            isIcon: ltePhoneL,
                                            role:
                                              ltePhoneL &&
                            ...
                            ? ltePhoneL
                              ? jsxRuntime.exports.jsx(
                                  ...
                                  __assign(
                                    ...
                                    { children: jsxRuntime.exports.jsx(Icon$1, { i: 'search' }) }
                                  )
                                )
                              : jsxRuntime.exports.jsx(
                                  'div',
                                  __assign(
                                    ...
                                    {
                                      children: jsxRuntime.exports.jsx(TextInput$1, {
                                ...
                                children: [
                                  ...
                                  jsxRuntime.exports.jsx(
                                    ...
                                    __assign(
                                      ...
                                      {
                                        children: jsxRuntime.exports.jsx(Icon$1, { i: 'backspace' })
                                      }
                                    )
                                  )
                                ]
      ...
      isSortVisible &&
        ...
        jsxRuntime.exports.jsx(
          ...
          __assign(
            ...
            { children: jsxRuntime.exports.jsx(DataTableSorting$1, { onClose: closeSortingPopup }) }
          )
        ),
      isFilterVisible &&
        jsxRuntime.exports.jsx(
          ...
          __assign(
            {
              targetElement: filterRef.current,
            ...
            {
              children: jsxRuntime.exports.jsx(DataTableFiltering$1, {
                onClose: closeFilteringPopup
              })
            }
          )
...
var filterVisibleColumns = function (columns, mobileColumns, isMobile) {
  ...
  return columns.filter(function (column) {
    return mobileColumns.indexOf(column.accessor) > -1;
  });
};
...
var DataTableBody = function () {
  ...
  var _b = React.useState(-1),
    selectedRowIndex = _b[0],
    setSelectedRowIndex = _b[1];
  ...
  return jsxRuntime.exports.jsxs('tbody', {
    children: [
      data.slice(start, end).map(function (row, rowIndex) {
        return jsxRuntime.exports.jsxs(
          'tr',
          __assign(
            { 'data-testid': 'alt-test-datatable-row' },
            {
              children: [
                visibleColumns.map(function (column, columnIndex) {
                  ...
                  return jsxRuntime.exports.jsx(
                    'td',
                    __assign({ className: 'alt-data-table__cell' }, { children: content }),
                    columnIndex
                  );
                }),
                ltePhoneL &&
                    ...
                    __assign(
                      {
                        ...
                        tabIndex: 0,
                        onClick: function () {
                          return setSelectedRowIndex(rowIndex);
                        }
                      },
                      { children: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_forward_ios' }) }
                    )
          ...
          __assign(
            ...
            },
            {
              children: jsxRuntime.exports.jsx(
                'div',
                __assign(
                  { className: 'alt-data-table-mobile-grid' },
                  {
                    children: columns.map(function (column, columnIndex) {
                      ...
                      return jsxRuntime.exports.jsxs(
                        'div',
                        __assign(
                          { className: 'alt-data-table-mobile-cell' },
                          {
                            children: [
                              jsxRuntime.exports.jsx(
                                'div',
                                __assign(
                                  { className: 'alt-data-table-mobile-cell__label' },
                                  { children: column.label || column.accessor }
                                )
                              ),
                              jsxRuntime.exports.jsx(
                                'div',
                                __assign(
                                  { className: 'alt-data-table-mobile-cell__value' },
                                  {
                                    children: column.Component
                                      ? jsxRuntime.exports.jsx(
                                          CustomComponent,
                                          __assign({}, column, {
...
var DataTableHeaderRow = function () {
  ...
  return jsxRuntime.exports.jsx(
    'tr',
    __assign(
      { className: 'alt-data-table__row', 'data-testid': 'alt-test-datatable-thead' },
      {
        children: visibleColumns.map(function (column, columnIndex) {
          return jsxRuntime.exports.jsxs(
            'th',
            __assign(
              {
                ...
                children: [
                  ...
                  sortBy === column.accessor &&
                    jsxRuntime.exports.jsx(
                      'div',
                      __assign(
                        { className: 'alt-data-table__sort-indicator' },
                        {
                          children: jsxRuntime.exports.jsx(Icon$1, {
...
var DataTablePagination = function () {
  ...
  return jsxRuntime.exports.jsxs(
    'div',
    __assign(
      { className: 'alt-data-table-pagination', 'data-testid': 'alt-test-datatable-pagination' },
      {
        children: [
          jsxRuntime.exports.jsx(
            Button$1,
            __assign(
              ...
              { children: jsxRuntime.exports.jsx(Icon$1, { i: 'arrow_back_ios' }) }
            )
          ),
          jsxRuntime.exports.jsxs(
            'div',
            __assign(
              { className: 'alt-data-table-pagination__progress' },
              {
                children: [
                  jsxRuntime.exports.jsx(
                    'span',
...
var DataTableFooter = function () {
  ...
  var ltePhoneL = useWindowSize().ltePhoneL;
  var t = useLocalization();
  return jsxRuntime.exports.jsx('tfoot', {
    children: jsxRuntime.exports.jsx(
      'td',
      __assign(
        {
        ...
        },
        {
          children: jsxRuntime.exports.jsxs(
            'div',
            __assign(
              { className: 'alt-data-table-footer' },
              {
                children: [
                  jsxRuntime.exports.jsx(
                    'div',
                  ...
                  initialData.length > limit &&
                    jsxRuntime.exports.jsx(
                      'div',
                      __assign(
                        { className: 'alt-data-table-footer__pagination' },
                        { children: jsxRuntime.exports.jsx(DataTablePagination$1, {}) }
                      )
                    )
                ]
              }
...
var DataTable = function (_a) {
  var _b = _a.data,
    ...
    _d = _a.limit,
    limit = _d === void 0 ? 20 : _d,
    _e = _a.searchBy,
    searchBy = _e === void 0 ? '' : _e,
    _f = _a.searchFunc,
    searchFunc = _f === void 0 ? defaultSearchFunc : _f,
    _g = _a.sortKeys,
    sortKeys = _g === void 0 ? [] : _g,
    _h = _a.filters,
    filters = _h === void 0 ? [] : _h,
    _j = _a.mobileColumns,
    mobileColumns = _j === void 0 ? [columns[0].accessor] : _j,
    className = _a.className;
  ...
  var _m = React.useState(),
    sortBy = _m[0],
    setSortBy = _m[1];
  var _o = React.useState(exports.Sort.asc),
    sortType = _o[0],
    setSortType = _o[1];
  var _p = React.useState([]),
    appliedFilters = _p[0],
    setAppliedFilters = _p[1];
  var filteredData = React.useMemo(
    function () {
      var result = __spreadArray([], data, true);
      if (searchBy && searchFunc && search.trim()) {
        result = result.filter(function (item) {
          return searchFunc({ item: item, field: searchBy, query: search.trim() });
        });
      }
      if (sortBy) {
      ...
      if (appliedFilters) {
        var _loop_1 = function (filter) {
          var filterConfig = filters.find(function (_filter) {
            return _filter.accessor === filter.accessor;
          });
          if (!filterConfig) {
            return 'continue';
          }
          switch (filterConfig.type) {
            ...
            case 'checkboxList':
              result = result.filter(function (item) {
                return defaultCheckboxesFilter({
                  item: item,
                  field: filterConfig.accessor,
                  value: filter.value
                });
    ...
    __assign(
      ...
      },
      {
        children: jsxRuntime.exports.jsxs(
          'table',
          __assign(
            { className: clsx('alt-data-table', className), 'data-testid': 'alt-test-datatable' },
            {
              children: [
                jsxRuntime.exports.jsxs('thead', {
                  children: [
                    isHeaderVisible && jsxRuntime.exports.jsx(DataTableHeader$1, {}),
                    jsxRuntime.exports.jsx(DataTableHeaderRow$1, {})
                  ]
                }),
                jsxRuntime.exports.jsx(DataTableBody$1, {}),
                jsxRuntime.exports.jsx(DataTableFooter$1, {})
              ]
            }
          )
        )
...
var Progress = function (_a) {
  var _b = _a.variant,
    variant = _b === void 0 ? ProgressVariant.default : _b,
    _c = _a.value,
    value = _c === void 0 ? 0 : _c,
    _d = _a.max,
    max = _d === void 0 ? 100 : _d,
    _e = _a.role,
    role = _e === void 0 ? exports.Role.default : _e,
    _f = _a.size,
    size = _f === void 0 ? exports.Size.medium : _f,
    className = _a.className;
      ...
      },
      {
        children: [
          ...
          variant === ProgressVariant.segmented &&
            new Array(max).fill(0).map(function (_, segmentIndex) {
              return jsxRuntime.exports.jsx(
                'div',
                {
...
var Heading = function (_a) {
  var children = _a.children,
    _b = _a.level,
    level = _b === void 0 ? 1 : _b,
    props = __rest$1(_a, ['children', 'level']);
  ...
  return jsxRuntime.exports.jsx(
    ...
    __assign(
      {
        tagName: tagName,
        className: clsx('alt-heading', 'alt-heading--level-'.concat(level), props.className)
      },
      props,
      { children: children }
    )
...
var Blockquote = function (_a) {
  var children = _a.children,
    ...
    cite = _a.cite,
    props = __rest$1(_a, ['children', 'className', 'author', 'classNames', 'innerProps', 'cite']);
  return jsxRuntime.exports.jsxs(
    'figure',
    __assign({ className: clsx('alt-blockquote', className) }, props, {
      children: [
        jsxRuntime.exports.jsx(
          Box$1,
          __assign(
            ...
            innerProps === null || innerProps === void 0 ? void 0 : innerProps.content,
            { children: children }
          )
        ),
        author &&
          jsxRuntime.exports.jsx('figcaption', {
            children: jsxRuntime.exports.jsx(
              'cite',
              __assign(
                { className: clsx('alt-blockquote__author', classNames.author) },
                innerProps === null || innerProps === void 0 ? void 0 : innerProps.author,
                { children: author }
              )
            )
          })
...
var Paragraph = function (_a) {
  ...
  return jsxRuntime.exports.jsx(
    Box$1,
    __assign({ tagName: 'p', className: clsx('alt-paragraph', className) }, props, {
      children: children
    })
  );
};
...
var Message = function (_a) {
  var title = _a.title,
    children = _a.children,
    _b = _a.role,
    role = _b === void 0 ? exports.Role.default : _b,
    ...
    __assign(
      ...
      },
      {
        children: [
          jsxRuntime.exports.jsx(
            'div',
            __assign({ className: 'alt-message__icon' }, { children: IconComponent })
          ),
          jsxRuntime.exports.jsxs(
            'div',
            __assign(
              { className: 'alt-message__content' },
              {
                children: [
                  title &&
                    jsxRuntime.exports.jsx(
                      ...
                      __assign(
                        {
                          className: 'alt-message__title',
                          'data-testid': 'alt-test-message-title'
                        },
                        { children: title }
                      )
                    ),
                  children &&
                    jsxRuntime.exports.jsx(
                      ...
                      __assign(
                        {
                          className: 'alt-message__description',
                          'data-testid': 'alt-test-message-description'
                        },
                        { children: children }
                      )
                    )
