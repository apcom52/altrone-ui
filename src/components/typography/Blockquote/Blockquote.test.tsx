...
describe('Typography.Blockquote', () => {
  ...
  test('should add cite attribute to blockquote', () => {
    render(<Blockquote author='Foo Bar' cite='https://google.com'>lorem ipsum</Blockquote>)
    const element = screen.getByText('lorem ipsum')
    expect(element).toHaveAttribute('cite', 'https://google.com')
  })

  test('should be customizable with classNames', () => {
    render(<Blockquote author='Foo Bar' cite='https://google.com' classNames={{
      content: 'demo-class',
      author: 'demo-class'
    }} className='parent-class' data-testid='blockquote'>lorem ipsum</Blockquote>)
