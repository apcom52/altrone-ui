...
const Blockquote = ({ children, className, author, classNames = {}, innerProps, cite, ...props }: BlockquoteProps) => {
  return <figure className={clsx('alt-blockquote', className)} {...props}>
    <Box
      tagName='blockquote'
      cite={cite}
