...
const NavigationListItem = ({ label, value, icon, submenu = [], onClick, selected = false, indicator }: NavigationItemProps) => {
  return <button
  ...
  >
    ...
    {indicator && <div className={clsx('alt-navigation-list-item__indicator', {
