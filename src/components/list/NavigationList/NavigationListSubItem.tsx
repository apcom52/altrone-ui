...
const NavigationListSubItem = ({ label, value, icon, submenu = [], onClick, indicator, selected = false }: NavigationSubItemProps) => {
  return <button
  ...
  >
    ...
    {indicator && <div className={clsx('alt-navigation-list-sub-item__indicator', {
      'alt-navigation-list-sub-item__indicator--position-corner': indicator.position === 'corner'
    })}>{indicator.value}</div>}
