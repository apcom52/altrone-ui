...
export const Empty = memo<EmptyProps>((props) => {
  ...
  const { ref, children, icon, transparent, className, style, ...restProps } =
    props;

  const cls = clsx(s.Empty, className, {
  ...
  return (
    <div ref={ref} className={cls} role="status" style={styles} {...restProps}>
