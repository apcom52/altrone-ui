...
describe('Form.ScrollableSelector', () => {
  ...
  test('should selects on option', async () => {
    ...
    const { rerender } = render(
      <ScrollableSelector value={value} options={DATA} onChange={onChange} />
    );
  ...
  test('should alignment works correctly', async () => {
    const { rerender } = render(
      <ScrollableSelector value={0} options={DATA} onChange={() => null} align={Align.start} />
    );
    ...
    rerender(
      <ScrollableSelector value={0} options={DATA} onChange={() => null} align={Align.end} />
    );
    ...
    rerender(
      <ScrollableSelector value={0} options={DATA} onChange={() => null} align={Align.center} />
    );
    scrollableSelector = screen.getByTestId('alt-test-scrollable-selector');
